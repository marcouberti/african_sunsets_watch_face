...
public class SunsetsBackgroundWearableConfigActivity extends Activity implements
    ...
    private void updateConfigDataItem(final int colorID) {
        ...
        configKeysToOverwrite.putInt(SunsetsWatchFaceUtil.KEY_BACKGROUND_COLOR,
                colorID);
    ...
    private static class ColorItem extends LinearLayout implements
        ...
        public ColorItem(Context context) {
            super(context);
            View.inflate(context, R.layout.image_picker_item, this);
        ...
        private void setColor(String cName) {
            ...
            colorName = cName;
            mColor.setBitmapResource(BitmapWatchFaceUtils.getBitmapPreviewResource(getContext(), cName));
        }

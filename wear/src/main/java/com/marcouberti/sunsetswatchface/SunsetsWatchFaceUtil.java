...
public final class SunsetsWatchFaceUtil {
    private static final String TAG = "NatureGradientsUtil";

    /**
     * The {@link DataMap} key for {@link SunsetsWatchFace} background color name.
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        SunsetsWatchFaceUtil.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        SunsetsWatchFaceUtil.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
